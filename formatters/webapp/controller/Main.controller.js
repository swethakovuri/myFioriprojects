sap.ui.define(
   ...
   //create global variable for formatter
   formatter: formatter,
         onInit: function () {
           ...
           var oModel = models.createMyJSONModel("models/sample2.json");
            ...
            var oRModel = models.createMYResoureModel();
            sap.ui.getCore().setModel(oRModel, "i18n");
         ...
         _bindValue: function(){
      //Binding- 4 ways we can do property binding
            var oTable = this.getView().byId("idTable");          
           // oTable.bindRows("/empTab/row");
            //syntax 4 for aggregation binding
